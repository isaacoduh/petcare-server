<x-app-layout>
    <div class="container lg:w-2/3 xl:w-2/3 mx-auto">
        ...
        <div x-data="{
                                ...
                                <div class="flex flex-col justify-between flex-1">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <div class="flex items-center">
                                            Qty: <input type="number" min="1" x-model="product.quantity" 
                                            @change="changeQuantity()"
                                            class="ml py-1 border-gray-200 focus:border-purple-600 focus:ring-purple-600 w-16" />
                                        </div>
            ...
            <template x-if="!cartItems.length">
                <div class="text-center py-8 text-gray-500">You don't have any items in cart!</div>
            </template>
        </div>
    </div>
</x-app-layout>