...
class AuthController extends Controller
{
    ...
    {
        $credentials = $request->validate(['email' => ['required', 'email'], 'password' => 'required', 'remember' => 'boolean']);
        ...
        if(!$user->is_admin){
            Auth::logout();
            return response(['message' => 'You do not have permission to authenticate as admin'], 403);
        }
